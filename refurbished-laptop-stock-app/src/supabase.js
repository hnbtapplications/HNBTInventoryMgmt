...
function toMovement(r,laptops){const x=laptops.find(z=>z.__dbId===r.laptop_id);return{id:r.id,laptopId:x?.["Laptop ID"]||r.laptop_id,type:r.movement_type,from:r.from_location,to:r.to_location,date:r.movement_at,reference:r.reference_no||"",amount:r.amount??"",paymentDate:r.payment_date||"",paymentMode:r.payment_mode||"",remarks:r.remarks||"",version:r.version_no||1,correctionReason:r.correction_reason||"",__dbId:r.id}}
